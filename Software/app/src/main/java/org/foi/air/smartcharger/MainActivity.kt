...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    private var onNewIntentListener: OnNewIntentListener? = null
    ...
    fun changeFragment(fragmentName: String){
         val fragment : Fragment = if(fragmentName=="ChargerConnectionFragment" && Charger.isChargerConnected())
             getFragmentByName("ChargerSimulatorFragment")
         else
    ...
    override fun onNewIntent(intent: Intent?) {
        ...
        onNewIntentListener?.newIntent(intent)
    }
